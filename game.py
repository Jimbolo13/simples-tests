# Mystery RPG - "Les Ombres de Valmont"
# A polished terminal-based role-playing mystery game
# Author: ChatGPT
# License: MIT
...
def intro(state):
    ...
    divider()
    slow_print(f"Bienvenue, {state.player_name}.")
    slow_print("Vous êtes appelé au manoir Valmont après un meurtre mystérieux...")
    slow_print("La victime : le comte Édouard de Valmont.")
    slow_print("Trois suspects. Un seul coupable.")
...
def ending(victory):
    ...
    if victory:
        ...
        slow_print("Justice est faite.")
    else:
        slow_print("Votre accusation est incorrecte...")
        slow_print("Le véritable coupable s'échappe dans l'ombre.")
        slow_print("Le mystère reste entier.")
